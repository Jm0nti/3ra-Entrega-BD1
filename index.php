...
<div class="container mt-5">
    ...
    <h1>Trabajo final BD1 - HotelManager</h1>
    ...
    <div class="integrantes">
        <h2>Integrantes</h2>
        <ul>
            <li>Santiago Eusse Gil</li>
            <li>Jhon Edison Pinto Hincapie</li>
            <li>Juan Luis Montiel Villalba</li>
        </ul>
    </div>
    ...
    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="empleado/empleado.php">Entidad EMPLEADO (Análogo a MECANICO)</a></li>
            <li><a href="hotel/hotel.php">Entidad HOTEL (Análogo a DEPARTAMENTO)</a></li>
            <li><a href="reserva/reserva.php">Entidad RESERVA (Análogo a REVISIÓN )</a></li>
